	...
	return (
		<UiDialog.Root open={open} onOpenChange={onClose}>
			<UiDialog.Portal>
				...
				<UiDialog.Content className="min-auto fixed left-1/2 top-1/2 w-full max-w-[480px] -translate-x-1/2 -translate-y-1/2 rounded-md bg-gray-dark p-8 outline-none">
